...
if(FREECIV_ENABLE_SERVER)
  ...
  check_symbol_exists(rl_completion_suppress_append "readline/readline.h"
...
# Create an imported target since it's not created by CMake :( Get a library
# name for IMPORTED_LOCATION
if(NOT EMSCRIPTEN AND NOT APPLE)
  add_library(lua UNKNOWN IMPORTED GLOBAL)
  list(GET LUA_LIBRARIES 0 loc)
  set_target_properties(
    lua PROPERTIES IMPORTED_LOCATION "${loc}" INTERFACE_INCLUDE_DIRECTORIES
                                              "${LUA_INCLUDE_DIR}")
...
# Define the GUI type for Win32 Qt programs Removes the console window that pops
# up with the GUI app
if(WIN32
   OR MINGW
   OR MSYS)
...
if(EMSCRIPTEN)
  ...
  set(CMAKE_EXE_LINKER_FLAGS
      "${CMAKE_EXE_LINKER_FLAGS} -s ERROR_ON_UNDEFINED_SYMBOLS=0")
endif()
